...
import {mockRespostas} from "../../data/formularioEmocao"
...
const corPorEmocao = (emocao: string, darkMode: boolean): string => {
  ...
  switch (emocao) {
    case "Feliz":
      return darkMode ? "text-green-400 " + baseClasses : "text-green-600 " + baseClasses;
    case "Cansado":
      return darkMode ? "text-yellow-400 " + baseClasses : "text-yellow-600 " + baseClasses;
    case "Estressado":
      return darkMode ? "text-red-400 " + baseClasses : "text-red-600 " + baseClasses;
    case "Neutro":
      return darkMode ? "text-gray-400 " + baseClasses : "text-gray-600 " + baseClasses;
    case "Motivado":
      return darkMode ? "text-blue-400 " + baseClasses : "text-blue-600 " + baseClasses;
    case "Ansioso":
      return darkMode ? "text-orange-400 " + baseClasses : "text-orange-600 " + baseClasses;
    default:
      return darkMode ? "text-purple-400 " + baseClasses : "text-purple-600 " + baseClasses;
  }
};
    ...
    <div className={`min-h-screen overflow-y-auto bg-linear-to-br py-6 px-4 sm:py-10 sm:px-6 transition-colors duration-300 ${
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-6 sm:mb-8 px-2">
          <h1 className={`text-xl sm:text-3xl font-bold mb-2 wrap-break-words leading-tight ${
            ...
            <div className="min-w-full">
              <table className="w-full min-w-[300px] text-sm">
                <thead className={`border-b transition-colors duration-300 ${
                  ...
                  <tr>
                    <th className={`py-3 px-3 text-xs font-semibold uppercase tracking-wider text-left ${
                    ...
                    <th className={`py-3 px-3 text-xs font-semibold uppercase tracking-wider text-center ${
                      darkMode ? "text-gray-300" : "text-gray-700"
                    }`}>
                      Intensidade
                    </th>
                ...
                <tbody>
                  {respostas.map((resposta, index) => (
                    ...
                    >
                      ...
                      <td className={`py-3 px-3 text-xs sm:text-sm whitespace-nowrap ${
                        corPorEmocao(resposta.emocao, darkMode)
                      }`}>
                        {resposta.emocao}
                      </td>
                      <td className="py-3 px-3">
                        <div className="flex items-center justify-center gap-2">
                          <div className={`w-16 sm:w-20 rounded-full h-2 overflow-hidden transition-colors duration-300 ${
                            darkMode ? "bg-gray-600" : "bg-gray-200"
                          }`}>
                            <div
                              className="h-2 rounded-full bg-linear-to-r from-blue-500 to-purple-600"
                              style={{ width: `${resposta.intensidade * 100}%` }}
                            />
                          </div>
                      ...
                      <td colSpan={3} className="text-center py-8">
                        <div className="flex flex-col items-center justify-center space-y-2">
                          ...
                          <div className={`text-xs ${
                            ...
                            Complete seu primeiro formulário
                          </div>
                        </div>
                      </td>
                    </tr>
